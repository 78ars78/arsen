...
const interval= setInterval( function(){
   ...
   if (ran > 1000 ) { clearInterval(interval); d=1; cre.style['top']=50; return cre.innerHTML="арсен <font color=black>  âûèãðàë! </font>"; }}
...
const interval1= setInterval( function(){
   ...
   if (ran1 >1000) { clearInterval(interval1); d=1;  cre.style['top']=200; return cre.innerHTML="арсен <font color=black>  âûèãðàëà! </font>";}}
...
const interval2= setInterval( function(){
   ...
   if (ran2 > 1000 ) { clearInterval(interval2); d=1; cre.style['top']=350;  return cre.innerHTML="арсен <font color=black>  âûèãðàë! </font>";}}
...
const interval3= setInterval( function(){
   ...
   if (ran3 > 1000 ) { clearInterval(interval3); d=1; cre.style['top']=500;  return cre.innerHTML="арсен <font color=black>  âûèãðàëà! </font>";}}
